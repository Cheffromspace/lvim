...
-- }
-- 
-- table.insert(O.lang, apex)
-- table.insert(O.lang, powershell)
-- 
-- require('myLsp.apex-ls')
-- require('myLsp.powershell-ls')
-- python
...
--     _apex = {
--         {'BufWinEnter', '*.cls,*.trigger,*.apex', 'setlocal filetype=apex' },
--         {'BufNewFile', '*.cls,*.trigger,*.apex', 'setlocal  filetype=apex' },
--         {'BufRead', '*.cls,*.trigger,*.apex', 'setlocal filetype=apex' },
--     }})
